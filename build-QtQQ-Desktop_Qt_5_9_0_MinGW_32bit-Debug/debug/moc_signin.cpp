...
QT_MOC_LITERAL(1, 7, 8), // "isSignIn"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 8), // "showHead"
QT_MOC_LITERAL(4, 26, 5), // "login"
QT_MOC_LITERAL(5, 32, 10) // "loginError"

    },
    "SignIn\0isSignIn\0\0showHead\0login\0"
    "loginError"
};
...
void SignIn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->isSignIn(); break;
        case 1: _t->showHead(); break;
        case 2: _t->login(); break;
        case 3: _t->loginError(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SignIn::isSignIn)) {
                *result = 0;
                return;
            }
        }
